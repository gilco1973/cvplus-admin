...
export const getBusinessMetrics = onCall({
    ...
    try {
        ...
        const [userMetrics, revenueMetrics, usageMetrics, conversionMetrics, engagementMetrics, performanceMetrics] = await Promise.all([
...
//# sourceMappingURL=getBusinessMetrics.js.map