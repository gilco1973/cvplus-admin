...
export const getCacheStats = onCall({
    ...
    try {
        ...
        throw new HttpsError('internal', 'Failed to get cache statistics', error);
    }
});
/**
...
export const warmCaches = onCall({
    ...
    try {
        ...
        throw new HttpsError('internal', error instanceof Error ? error.message : 'Cache warming failed');
    }
});
/**
...
export const clearCaches = onCall({
    ...
    try {
        ...
        throw new HttpsError('internal', error instanceof Error ? error.message : 'Cache clearing failed');
    }
});
//# sourceMappingURL=getCacheStats.js.map