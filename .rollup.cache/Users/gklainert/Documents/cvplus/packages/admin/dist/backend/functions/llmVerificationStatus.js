...
export const llmVerificationStatus = onRequest({
    ...
    try {
        const { action, timeRange = '24h', format = 'json', limit = 50 } = req.body;
        if (!action) {
...
function generateRecommendations(dashboardData) {
    ...
    if (dashboardData.topServices.some((service) => service.successRate < 90)) {
...
//# sourceMappingURL=llmVerificationStatus.js.map