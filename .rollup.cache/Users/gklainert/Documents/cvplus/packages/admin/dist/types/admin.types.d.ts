...
export declare enum UserManagementView {
    TABLE = "table",
    CARDS = "cards",
    DETAILED = "detailed"
}
export declare enum ContentModerationView {
    QUEUE = "queue",
    GRID = "grid",
    TIMELINE = "timeline"
}
export declare enum SystemMonitoringView {
    DASHBOARD = "dashboard",
    METRICS = "metrics",
    LOGS = "logs"
}
export declare enum AnalyticsView {
    OVERVIEW = "overview",
    DETAILED = "detailed",
    CUSTOM = "custom"
}
...
export declare enum AdminAlertType {
    SYSTEM = "system",
    SECURITY = "security",
    USER = "user",
    CONTENT = "content",
...
export declare enum AdminAlertSeverity {
    INFO = "info",
    WARNING = "warning",
    ERROR = "error",
    CRITICAL = "critical"
