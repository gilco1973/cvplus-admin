...
export const getUserUsageStats = onCall({
    ...
    try {
        ...
        const uniqueCVHashes = new Set(uploadsQuery.docs
        ...
        throw new HttpsError('internal', 'Failed to get user usage statistics', error);
    }
});
//# sourceMappingURL=getUserUsageStats.js.map