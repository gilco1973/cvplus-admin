...
export declare enum UserNoteType {
    GENERAL = "general",
    SUPPORT = "support",
    BILLING = "billing",
    SECURITY = "security",
...
export declare enum UserNoteVisibility {
    INTERNAL = "internal",
    TEAM = "team",
...
export declare enum PaymentRiskLevel {
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high",
    BLOCKED = "blocked"
...
export declare enum SupportPriority {
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high",
    URGENT = "urgent",
...
export declare enum FeatureProficiency {
    BEGINNER = "beginner",
...
export declare enum SessionFrequency {
    DAILY = "daily",
    WEEKLY = "weekly",
    MONTHLY = "monthly",
    QUARTERLY = "quarterly",
...
export declare enum ValueSegment {
    LOW_VALUE = "low_value",
